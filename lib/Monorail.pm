...
protodbix.  The protodbix is generated by starting with an empty DBIC schema
...
sub _schema_from_current_migrations {
    ...
    return $self->_parse_dbix_class($proto);
}
